...
def generate_table(search_value, max_rows):
    ...
    styles = [{'if': {'column_id': 'ward_NEWS_over_3', 'filter_query': '{ward_NEWS_over_3} contains ' + str(val)}, 'backgroundColor': background_color, 'color': 'white'} for val, background_color in zip([0, 1, 2], ['#FF0000', "#00FF00", '#0000FF'])]
